...
public struct CatViewWithoutCompletions: View {
    ...
    func requestData() {
        ...
        Task {
            ...
            // O `await` indica que o código deve "esperar" até que a função termine antes de continuar. Ou seja, aqui é como se o código o compilador fizesse passo-a-passo esperando cada coisa (Sequencial mesmo)
